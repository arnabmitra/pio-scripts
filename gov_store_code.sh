...
--title "test" --description "test" --run-as $(${PROVENANCE_DEV_DIR}/build/provenanced keys show -a node0 -t --home ${PROVENANCE_DEV_DIR}/build/node0) --instantiate-everybody "true" \
  --from node0 \
