...
${PROVENANCE_DEV_DIR}/build/provenanced tx gov submit-legacy-proposal wasm-store wasms/marketpalace_raise_contract.wasm \
--title "Raise Contract v2.1.0" --description "https://github.com/FigureTechnologies/marketpalace-raise-contract/tree/t0.5.0" --run-as $(${PROVENANCE_DEV_DIR}/build/provenanced keys show -a node0 -t --home ${PROVENANCE_DEV_DIR}/build/node0) --instantiate-everybody "true" \
